...
class SarahWindowsMastery:
    ...
    def study_services(self):
        ...
        # Get service details
        self.api.execute_command('sc query type= service state= all > C:\\SarahCore\\services_knowledge.txt')
    ...
    def study_processes(self):
        ...
        # Get process tree
        self.api.execute_command('wmic process get ProcessId,ParentProcessId,Name,CommandLine /format:csv > C:\\SarahCore\\process_tree.csv')
    ...
    def study_network(self):
        ...
        # Network adapters
        self.api.execute_command('ipconfig /all > C:\\SarahCore\\network_config.txt')
        
        # Routing table
        self.api.execute_command('route print > C:\\SarahCore\\routing_table.txt')
    ...
    def study_file_system(self):
        ...
        # Disk structure
        self.api.execute_command('fsutil fsinfo drives > C:\\SarahCore\\drives.txt')
        
        # Volume info
        self.api.execute_command('wmic logicaldisk get Caption,FileSystem,Size,FreeSpace /format:csv > C:\\SarahCore\\volumes.csv')
    ...
    def study_user_data(self):
        ...
        self.api.execute_command(f'{cmd} > C:\\SarahCore\\all_user_data.txt')
    ...
    def study_applications(self):
        ...
        self.api.execute_command(f'{cmd} > C:\\SarahCore\\installed_apps.txt')
    ...
    def study_powershell(self):
        ...
        # Export cmdlet list
        self.api.execute_command('powershell -Command "Get-Command | Export-Csv C:\\SarahCore\\powershell_cmdlets.csv"')
