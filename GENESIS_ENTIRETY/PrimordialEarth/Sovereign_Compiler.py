...
class SovereignCompiler:
    ...
    def compile_and_run(self, sigma_code):
        print("[Σ COMPILER] Initiating Resonance Check...")
        
        # 1. Verification of Resonance
        if str(self.resonance_anchor) not in sigma_code:
            print("[Σ ERROR] Code is Non-Resonant. Discarding Noise.")
            return False
            
        print("[Σ COMPILER] Parsing Axioms...")
