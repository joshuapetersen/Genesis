...
pub const VAR_10: u64 = 10;
pub const VAR_1000000: u64 = 1000000;
pub const VAR_200000: u64 = 200000;
...
impl ThousandThousandFilter {
    ...
    pub fn scan_memories(&self, root_dir: &str) {
        ...
        all_results . sort ( key = |x | {  x [ 1 ] , reverse = true ) };
        for path , score , passed in all_results [ : VAR_10 ] .iter() {
