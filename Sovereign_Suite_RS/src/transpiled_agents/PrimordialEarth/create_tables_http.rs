//! create_tables_http.py (Rust Edition)
...
pub const project_ref: &str = "duuycxgqbhrqmwapnjhk";
pub const resp2: f64 = requests . post (;
pub const resp3: f64 = requests . get (;
