//! configureLog-v1-FailConfigure-check.py (Rust Edition)
...
pub fn check_reply(r: &str) {
        ...
        check_index_object ( r [ "configureLog-v1" ] , "configureLog" , 1 , 0 , None /* Option */ );
        pub fn check_reply_client_bar ( r ) {
        assert is_dict ( r );
        ...
        check_index_object ( responses [ 0 ] , "configureLog" , 1 , 0 , None /* Option */ );
