...
pub fn check_reply(q: &str) {
        ...
        check_error ( q , "query root is !an object" );
        ...
        check_error ( q [ "responses" ] , "'requests' member is !an array" );
        ...
        check_error ( r [ 1 ] , "'kind' member is !a string" );
        check_error ( r [ 2 ] , "'kind' member is !a string" );
        check_error ( r [ 3 ] , "'kind' member is !a string" );
        ...
        assert is_list ( r );
        assert len ( r ) == 3;
        check_error ( r [ 0 ] , "request is !an object" );
        check_error ( r [ 1 ] , "request is !an object" );
        check_error ( r [ 2 ] , "request is !an object" );
        ...
        check_error ( r , "'version' object 'major' member is !a non-negative integer" );
        pub fn check_query_response_array_negative_minor_version ( r ) {
        check_error ( r , "'version' object 'minor' member is !a non-negative integer" );
        pub fn check_query_response_array_negative_version ( r ) {
        check_error ( r , "'version' array entry is !a non-negative integer || object" );
        ...
        check_error ( r , "'version' member is !a non-negative integer, object, || array" );
