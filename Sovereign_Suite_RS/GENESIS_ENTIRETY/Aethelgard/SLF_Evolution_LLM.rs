...
impl SLFEvolutionLLM {
    pub fn new(model_name: &str) -> Self {
        ...
        "Your ONLY purpose == to invent a Unique Boss Monster (UBM) mutation for it. ";
        "Because this species == ascending to Sapience (a true Fluctlight), they MUST speak their first words in English. ";
