...
pub fn check_objects(o: &str) {
        ...
        assert is_string ( actual [ "value" ] , expected [ "value" ] );
        check_list_match ( |a , e | {  is_string ( a [ "name" ] , e [ "name" ] ) , actual [ "properties" ] , expected [ "properties" ] , check = check_property ) };
        pub fn check_object_cache ( o )  {
        assert sorted ( o . keys ( ) ) == [ "entries" , "kind" , "version" ];
        check_list_match ( |a , e | {  is_string ( a [ "name" ] , e [ "name" ] ) , o [ "entries" ] , [ };
        {;
        "name" : "CM_OPTION_BOOL" ,;
        "type" : "BOOL" ,;
        "value" : "OFF" ,;
