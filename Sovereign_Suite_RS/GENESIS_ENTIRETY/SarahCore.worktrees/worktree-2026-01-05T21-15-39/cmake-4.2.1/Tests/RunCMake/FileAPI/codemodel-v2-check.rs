//! codemodel-v2-check.py (Rust Edition)
...
pub fn read_codemodel_json_data(filename: &str) {
        ...
        assert b == None /* Option */;
        pub fn check_backtraces ( t , actual , expected )  {
        ...
        i + = 1;
        pub fn check_directory ( c , major , minor )  {
        pub fn _check ( actual , expected )  {
        ...
        if expected [ "parentSource" ] is !None /* Option */ {
        ...
        if expected [ "childSources" ] is !None /* Option */ {
        expected_keys . append ( "childIndexes" );
        check_list_match ( |a , e | {  matches ( c [ "directories" ] [ a ] [ "source" ] , e ) , };
        actual [ "childIndexes" ] , expected [ "childSources" ] ,;
        missing_exception = |e | {  "Child source: %s" % e , };
        extra_exception = |a | {  "Child source: %s" % a [ "source" ] ) };
        if expected [ "targetIds" ] is !None /* Option */ {
        expected_keys . append ( "targetIndexes" );
        check_list_match ( |a , e | {  matches ( c [ "targets" ] [ a ] [ "id" ] , e ) , };
        actual [ "targetIndexes" ] , expected [ "targetIds" ] ,;
        missing_exception = |e | {  "Target ID: %s" % e , };
        extra_exception = |a | {  "Target ID: %s" % c [ "targets" ] [ a ] [ "id" ] ) };
        if expected [ "abstractTargetIds" ] is !None /* Option */ {
        expected_keys . append ( "abstractTargetIndexes" );
        check_list_match ( |a , e | {  matches ( c [ "abstractTargets" ] [ a ] [ "id" ] , e ) , };
        actual [ "abstractTargetIndexes" ] , expected [ "abstractTargetIds" ] ,;
        missing_exception = |e | {  "Abstract target ID: %s" % e , };
        extra_exception = |a | {  "Abstract target ID: %s" % c [ "abstractTargets" ] [ a ] [ "id" ] ) };
        if expected [ "minimumCMakeVersion" ] is !None /* Option */ {
        ...
        if expected [ "hasInstallRule" ] is !None /* Option */ {
        ...
        for ad , ed in zip ( a [ "fileSetDirectories" ] , e [ "fileSetDirectories" ] ) .iter() {
        assert matches ( ad , ed );
        if e . get ( "fileSetTarget" , None /* Option */ ) is !None /* Option */ {
        ...
        assert is_int ( at [ "index" ] );
        assert c [ "targets" ] [ at [ "index" ] ] [ "name" ] == et [ "index" ];
        if e . get ( "cxxModuleBmiTarget" , None /* Option */ ) is !None /* Option */ {
        ...
        pub fn check_target ( c , major , minor )  {
        pub fn _check ( actual , expected )  {
        assert is_dict ( actual );
        ...
        pub fn check_file_set ( actual , expected )  {
        assert is_dict ( actual );
        ...
        check_list_match ( |a , e | {  matches ( a , e ) , actual [ "baseDirectories" ] , };
        expected [ "baseDirectories" ] ,;
        check_exception = |a , e | {  "File set base directory (check): %s" % a , };
        missing_exception = |e | {  "File set base directory (missing): %s" % e , };
        extra_exception = |a | {  "File set base directory (extra): %s" % a ) };
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        pub fn check_source ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ "path" ];
        if expected [ "fileSetName" ] is !None /* Option */ {
        expected_keys . append ( "fileSetIndex" );
        assert is_string ( obj [ "fileSets" ] [ actual [ "fileSetIndex" ] ] [ "name" ] , expected [ "fileSetName" ] );
        if expected [ "compileGroupLanguage" ] is !None /* Option */ {
        ...
        if expected [ "sourceGroupName" ] is !None /* Option */ {
        ...
        if expected [ "backtrace" ] is !None /* Option */ {
        expected_keys . append ( "backtrace" );
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        if expected [ "fileSets" ] is !None /* Option */ {
        expected_keys . append ( "fileSets" );
        check_list_match ( |a , e | {  matches ( a [ "name" ] , e [ "name" ] ) , obj [ "fileSets" ] , };
        expected [ "fileSets" ] , check = check_file_set ,;
        check_exception = |a , e | {  "File set: %s" % a [ "name" ] , };
        missing_exception = |e | {  "File set: %s" % e [ "name" ] , };
        extra_exception = |a | {  "File set: %s" % a [ "name" ] ) };
        check_list_match ( |a , e | {  matches ( a [ "path" ] , e [ "path" ] ) , obj [ "sources" ] , };
        expected [ "sources" ] , check = check_source ,;
        check_exception = |a , e | {  "Source file: %s" % a [ "path" ] , };
        missing_exception = |e | {  "Source file: %s" % e [ "path" ] , };
        extra_exception = |a | {  "Source file: %s" % a [ "path" ] ) };
        if expected [ "backtrace" ] is !None /* Option */ {
        expected_keys . append ( "backtrace" );
        check_backtrace ( obj , obj [ "backtrace" ] , expected [ "backtrace" ] );
        if expected [ "folder" ] is !None /* Option */ {
        ...
        if expected [ "nameOnDisk" ] is !None /* Option */ {
        expected_keys . append ( "nameOnDisk" );
        assert matches ( obj [ "nameOnDisk" ] , expected [ "nameOnDisk" ] );
        if expected [ "artifacts" ] is !None /* Option */ {
        expected_keys . append ( "artifacts" );
        pub fn check_artifact ( actual , expected )  {
        assert is_dict ( actual );
        assert sorted ( actual . keys ( ) ) == [ "path" ];
        check_list_match ( |a , e | {  matches ( a [ "path" ] , e [ "path" ] ) , };
        obj [ "artifacts" ] , expected [ "artifacts" ] ,;
        check = check_artifact ,;
        check_exception = |a , e | {  "Artifact: %s" % a [ "path" ] , };
        missing_exception = |e | {  "Artifact: %s" % e [ "path" ] , };
        extra_exception = |a | {  "Artifact: %s" % a [ "path" ] ) };
        if expected [ "isGeneratorProvided" ] is !None /* Option */ {
        expected_keys . append ( "isGeneratorProvided" );
        assert is_bool ( obj [ "isGeneratorProvided" ] , expected [ "isGeneratorProvided" ] );
        if expected [ "install" ] is !None /* Option */ {
        ...
        pub fn check_install_destination ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ "path" ];
        if expected [ "backtrace" ] is !None /* Option */ {
        expected_keys . append ( "backtrace" );
        ...
        check_exception = |a , e | {  "Install path: %s" % a [ "path" ] , };
        missing_exception = |e | {  "Install path: %s" % e [ "path" ] , };
        extra_exception = |a | {  "Install path: %s" % a [ "path" ] ) };
        if "launchers" in expected {
        if expected [ "launchers" ] is !None /* Option */ {
        expected_keys . append ( "launchers" );
        pub fn check_launcher ( actual , expected )  {
        assert is_dict ( actual );
        ...
        if "arguments" in expected {
        if expected [ "arguments" ] is !None /* Option */ {
        check_list_match ( |a , e | {  matches ( a , e ) , };
        actual [ "arguments" ] , expected [ "arguments" ] ,;
        missing_exception = |e | {  "argument: %s" % e , };
        extra_exception = |a | {  "argument: %s" % actual [ "arguments" ] ) };
        check_list_match ( |a , e | {  matches ( a [ "type" ] , e [ "type" ] ) , };
        obj [ "launchers" ] , expected [ "launchers" ] ,;
        check = check_launcher ,;
        check_exception = |a , e | {  "launchers: %s" % a , };
        missing_exception = |e | {  "launchers: %s" % e , };
        extra_exception = |a | {  "launchers: %s" % a ) };
        if "debugger" in expected {
        if expected [ "debugger" ] is !None /* Option */ {
        ...
        if expected [ "link" ] is !None /* Option */ {
        ...
        for f in obj [ "link" ] [ "commandFragments" ] .iter() {
        assert is_dict ( f );
        assert sorted ( f . keys ( ) ) == [ "fragment" , "role" ] || sorted ( f . keys ( ) ) == [ "backtrace" , "fragment" , "role" ];
        assert is_string ( f [ "fragment" ] );
        assert is_string ( f [ "role" ] );
        assert f [ "role" ] in ( "flags" , "libraries" , "libraryPath" , "frameworkPath" );
        if expected [ "link" ] [ "commandFragments" ] is !None /* Option */ {
        pub fn check_link_command_fragments ( actual , expected )  {
        assert is_dict ( actual );
        ...
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        check_list_match ( |a , e | {  matches ( a [ "fragment" ] , e [ "fragment" ] ) , };
        obj [ "link" ] [ "commandFragments" ] , expected [ "link" ] [ "commandFragments" ] ,;
        check = check_link_command_fragments ,;
        check_exception = |a , e | {  "Link fragment: %s" % a [ "fragment" ] , };
        missing_exception = |e | {  "Link fragment: %s" % e [ "fragment" ] , };
        extra_exception = |a | {  "Link fragment: %s" % a [ "fragment" ] , };
        allow_extra = true );
        if expected [ "link" ] [ "lto" ] is !None /* Option */ {
        ...
        if expected [ "archive" ] is !None /* Option */ {
        ...
        for f in obj [ "archive" ] [ "commandFragments" ] .iter() {
        assert is_dict ( f );
        assert sorted ( f . keys ( ) ) == [ "fragment" , "role" ];
        assert is_string ( f [ "fragment" ] );
        assert is_string ( f [ "role" ] );
        assert f [ "role" ] in ( "flags" );
        if expected [ "archive" ] [ "lto" ] is !None /* Option */ {
        ...
        if expected [ "dependencies" ] is !None /* Option */ {
        expected_keys . append ( "dependencies" );
        pub fn check_dependency ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ "id" ];
        if expected [ "backtrace" ] is !None /* Option */ {
        expected_keys . append ( "backtrace" );
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        check_list_match ( |a , e | {  matches ( a [ "id" ] , e [ "id" ] ) , };
        obj [ "dependencies" ] , expected [ "dependencies" ] ,;
        check = check_dependency ,;
        check_exception = |a , e | {  "Dependency ID: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Dependency ID: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Dependency ID: %s" % a [ "id" ] ) };
        pub fn is_same_link_library ( actual , expected )  {
        if "id" in actual {
        return  expected [ "id" ] is !None /* Option */ && matches ( actual [ "id" ] , expected [ "id" ] );
        if "fragment" in actual {
        return  expected [ "fragment" ] is !None /* Option */ && is_string ( actual [ "fragment" ] , expected [ "fragment" ] );
        assert false;
        if expected [ "linkLibraries" ] is !None /* Option */ {
        expected_keys . append ( "linkLibraries" );
        pub fn check_link_library ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ ];
        if expected [ "id" ] is !None /* Option */ {
        ...
        expected_keys . append ( "backtrace" );
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        if expected [ "fromDependency" ] is !None /* Option */ {
        ...
        check_exception = |a , e | {  "Mismatched link library: %s" % ( a [ "id" ] iformat!("id" in a else a [ "fragment" ] ) , });
        missing_exception = |e | {  "Missing link library: %s" % ( e [ "id" ] if e [ "id" ] == !None /* Option */ else e [ "fragment" ] ) , };
        extra_exception = |a | {  "Extra link library: %s" % ( a [ "id" ] iformat!("id" in a else a [ "fragment" ] ) ) });
        if expected [ "interfaceLinkLibraries" ] is !None /* Option */ {
        expected_keys . append ( "interfaceLinkLibraries" );
        pub fn check_interface_link_library ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ ];
        if expected [ "id" ] is !None /* Option */ {
        expected_keys . append ( "id" );
        ...
        check_exception = |a , e | {  "Mismatched interface link library: %s" % ( a [ "id" ] iformat!("id" in a else a [ "fragment" ] ) , });
        missing_exception = |e | {  "Missing interface link library: %s" % ( e [ "id" ] if e [ "id" ] == !None /* Option */ else e [ "fragment" ] ) , };
        extra_exception = |a | {  "Extra interface link library: %s" % ( a [ "id" ] iformat!("id" in a else a [ "fragment" ] ) ) });
        if expected [ "compileDependencies" ] is !None /* Option */ {
        expected_keys . append ( "compileDependencies" );
        pub fn check_usage_dependency ( actual , expected )  {
        assert is_dict ( actual );
        assert matches ( actual [ "id" ] , expected [ "id" ] );
        expected_keys = [ "id" ];
        if expected [ "backtrace" ] is !None /* Option */ {
        ...
        check_exception = |a , e | {  "Mismatched compile dependency: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Missing compile dependency: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Extra compile dependency: %s" % a [ "id" ] ) };
        pub fn check_only_target_dependency ( actual , expected )  {
        assert is_dict ( actual );
        assert matches ( actual [ "id" ] , expected [ "id" ] );
        expected_keys = [ "id" ];
        if expected [ "backtrace" ] is !None /* Option */ {
        ...
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        if expected [ "interfaceCompileDependencies" ] is !None /* Option */ {
        ...
        check_exception = |a , e | {  "Mismatched interface compile dependency: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Missing interface compile dependency: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Extra interface compile dependency: %s" % a [ "id" ] ) };
        if expected [ "objectDependencies" ] is !None /* Option */ {
        expected_keys . append ( "objectDependencies" );
        check_list_match ( |a , e | {  matches ( a [ "id" ] , e [ "id" ] ) , };
        obj [ "objectDependencies" ] , expected [ "objectDependencies" ] ,;
        check = check_only_target_dependency ,;
        check_exception = |a , e | {  "Mismatched object dependency: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Missing object dependency: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Extra object dependency: %s" % a [ "id" ] ) };
        if expected [ "orderDependencies" ] is !None /* Option */ {
        expected_keys . append ( "orderDependencies" );
        check_list_match ( |a , e | {  matches ( a [ "id" ] , e [ "id" ] ) , };
        obj [ "orderDependencies" ] , expected [ "orderDependencies" ] ,;
        check = check_only_target_dependency ,;
        check_exception = |a , e | {  "Mismatched order dependency: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Missing order dependency: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Extra order dependency: %s" % a [ "id" ] ) };
        if expected [ "sourceGroups" ] is !None /* Option */ {
        expected_keys . append ( "sourceGroups" );
        pub fn check_source_group ( actual , expected )  {
        assert is_dict ( actual );
        assert sorted ( actual . keys ( ) ) == [ "name" , "sourceIndexes" ];
        check_list_match ( |a , e | {  matches ( obj [ "sources" ] [ a ] [ "path" ] , e ) , };
        actual [ "sourceIndexes" ] , expected [ "sourcePaths" ] ,;
        missing_exception = |e | {  "Source path: %s" % e , };
        extra_exception = |a | {  "Source path: %s" % obj [ "sources" ] [ a ] [ "path" ] ) };
        check_list_match ( |a , e | {  is_string ( a [ "name" ] , e [ "name" ] ) , };
        obj [ "sourceGroups" ] , expected [ "sourceGroups" ] ,;
        check = check_source_group ,;
        check_exception = |a , e | {  "Source group: %s" % a [ "name" ] , };
        missing_exception = |e | {  "Source group: %s" % e [ "name" ] , };
        extra_exception = |a | {  "Source group: %s" % a [ "name" ] ) };
        if expected [ "compileGroups" ] is !None /* Option */ {
        expected_keys . append ( "compileGroups" );
        pub fn check_compile_group ( actual , expected )  {
        assert is_dict ( actual );
        ...
        for f in actual [ "compileCommandFragments" ] .iter() {
        assert is_dict ( f );
        assert is_string ( f [ "fragment" ] );
        if expected [ "compileCommandFragments" ] is !None /* Option */ {
        pub fn check_compile_command_fragments ( actual , expected )  {
        assert is_dict ( actual );
        ...
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        check_list_match ( |a , e | {  is_string ( a [ "fragment" ] , e [ "fragment" ] ) , };
        actual [ "compileCommandFragments" ] , expected [ "compileCommandFragments" ] ,;
        check = check_compile_command_fragments ,;
        check_exception = |a , e | {  "Compile fragment: %s" % a [ "fragment" ] , };
        missing_exception = |e | {  "Compile fragment: %s" % e [ "fragment" ] , };
        extra_exception = |a | {  "Compile fragment: %s" % a [ "fragment" ] , };
        allow_extra = true );
        if expected [ "includes" ] is !None /* Option */ {
        expected_keys . append ( "includes" );
        pub fn check_include ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ "path" ];
        if expected [ "isSystem" ] is !None /* Option */ {
        ...
        check = check_include ,;
        check_exception = |a , e | {  "Include path: %s" % a [ "path" ] , };
        missing_exception = |e | {  "Include path: %s" % e [ "path" ] , };
        extra_exception = |a | {  "Include path: %s" % a [ "path" ] ) };
        if expected [ "frameworks" ] is !None /* Option */ {
        ...
        check = check_include ,;
        check_exception = |a , e | {  "Framework path: %s" % a [ "path" ] , };
        missing_exception = |e | {  "Framework path: %s" % e [ "path" ] , };
        extra_exception = |a | {  "Framework path: %s" % a [ "path" ] ) };
        if "precompileHeaders" in expected {
        expected_keys . append ( "precompileHeaders" );
        pub fn check_precompile_header ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ "backtrace" , "header" ];
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        check_list_match ( |a , e | {  matches ( a [ "header" ] , e [ "header" ] ) , };
        actual [ "precompileHeaders" ] , expected [ "precompileHeaders" ] ,;
        check = check_precompile_header ,;
        check_exception = |a , e | {  "Precompile header: %s" % a [ "header" ] , };
        missing_exception = |e | {  "Precompile header: %s" % e [ "header" ] , };
        extra_exception = |a | {  "Precompile header: %s" % a [ "header" ] ) };
        if "languageStandard" in expected {
        expected_keys . append ( "languageStandard" );
        pub fn check_language_standard ( actual , expected )  {
        assert is_dict ( actual );
        ...
        if expected [ "defines" ] is !None /* Option */ {
        expected_keys . append ( "defines" );
        pub fn check_define ( actual , expected )  {
        assert is_dict ( actual );
        ...
        check_backtrace ( obj , actual [ "backtrace" ] , expected [ "backtrace" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        check_list_match ( |a , e | {  is_string ( a [ "define" ] , e [ "define" ] ) , };
        actual [ "defines" ] , expected [ "defines" ] ,;
        check = check_define ,;
        check_exception = |a , e | {  "Define: %s" % a [ "define" ] , };
        missing_exception = |e | {  "Define: %s" % e [ "define" ] , };
        extra_exception = |a | {  "Define: %s" % a [ "define" ] ) };
        if "sysroot" in actual {
        expected_keys . append ( "sysroot" );
        assert is_string ( actual [ "sysroot" ] );
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        check_list_match ( |a , e | {  is_string ( a [ "language" ] , e [ "language" ] ) , };
        obj [ "compileGroups" ] , expected [ "compileGroups" ] ,;
        check = check_compile_group ,;
        check_exception = |a , e | {  "Compile group: %s" % a [ "language" ] , };
        missing_exception = |e | {  "Compile group: %s" % e [ "language" ] , };
        extra_exception = |a | {  "Compile group: %s" % a [ "language" ] ) };
        assert sorted ( obj . keys ( ) ) == sorted ( expected_keys );
        return  _check;
        pub fn check_project ( c )  {
        pub fn _check ( actual , expected )  {
        assert is_dict ( actual );
        expected_keys = [ "name" , "directoryIndexes" ];
        check_list_match ( |a , e | {  matches ( c [ "directories" ] [ a ] [ "source" ] , e ) , };
        actual [ "directoryIndexes" ] , expected [ "directorySources" ] ,;
        missing_exception = |e | {  "Directory source: %s" % e , };
        extra_exception = |a | {  "Directory source: %s" % c [ "directories" ] [ a ] [ "source" ] ) };
        if expected [ "parentName" ] is !None /* Option */ {
        expected_keys . append ( "parentIndex" );
        assert is_int ( actual [ "parentIndex" ] );
        assert is_string ( c [ "projects" ] [ actual [ "parentIndex" ] ] [ "name" ] , expected [ "parentName" ] );
        if expected [ "childNames" ] is !None /* Option */ {
        expected_keys . append ( "childIndexes" );
        check_list_match ( |a , e | {  is_string ( c [ "projects" ] [ a ] [ "name" ] , e ) , };
        actual [ "childIndexes" ] , expected [ "childNames" ] ,;
        missing_exception = |e | {  "Child name: %s" % e , };
        extra_exception = |a | {  "Child name: %s" % c [ "projects" ] [ a ] [ "name" ] ) };
        if expected [ "targetIds" ] is !None /* Option */ {
        expected_keys . append ( "targetIndexes" );
        check_list_match ( |a , e | {  matches ( c [ "targets" ] [ a ] [ "id" ] , e ) , };
        actual [ "targetIndexes" ] , expected [ "targetIds" ] ,;
        ...
        assert sorted ( actual . keys ( ) ) == sorted ( expected_keys );
        return  _check;
        pub fn gen_check_directories ( c , g )  {
        expected = [;
        ...
        if e [ "parentSource" ] is !None /* Option */ {
        e [ "targetIds" ] = filter_list ( |t | {  !matches ( t , "^\\^ZERO_CHECK" ) , e [ "targetIds" ] ) };
        } else if g [ "name" ] == "Xcode" {
        if ";" in os . environ . get ( "CMAKE_OSX_ARCHITECTURES" , "" ) {
        for e in expected .iter() {
        e [ "targetIds" ] = filter_list ( |t | {  !matches ( t , "^\\^(link_imported_object_exe)" ) , e [ "targetIds" ] ) };
        e [ "abstractTargetIds" ] = filter_list ( |t | {  !matches ( t , "^\\^(imported_object_lib)" ) , e [ "abstractTargetIds" ] ) };
        } else {
        for e in expected .iter() {
        e [ "targetIds" ] = filter_list ( |t | {  !matches ( t , "^\\^(ALL_BUILD|ZERO_CHECK)" ) , e [ "targetIds" ] ) };
        if sys . platform in ( "win32" , "cygwin" , "msys" ) || "aix" in sys . platform {
        for e in expected .iter() {
        e [ "installers" ] = list ( filter ( |i | {  i [ "targetInstallNamelink" ] == None /* Option */ || i [ "targetInstallNamelink" ] == "skip" , e [ "installers" ] ) ) };
        for i in e [ "installers" ] .iter() {
        i [ "targetInstallNamelink" ] = None /* Option */;
        if sys . platform !in ( "win32" , "cygwin" , "msys" ) {
        for e in expected .iter() {
        e [ "installers" ] = list ( filter ( |i | {  !i . get ( "_dllExtra" , false ) , e [ "installers" ] ) ) };
        if "aix" !in sys . platform {
        for i in e [ "installers" ] .iter() {
        if "pathsNamelink" in i {
        i [ "paths" ] = i [ "pathsNamelink" ];
        if sys . platform !in ( "win32" , "darwin" ) && "linux" !in sys . platform {
        for e in expected .iter() {
        e [ "installers" ] = list ( filter ( |i | {  i [ "type" ] != "runtimeDependencySet" , e [ "installers" ] ) ) };
        if sys . platform != "darwin" {
        for e in expected .iter() {
        e [ "installers" ] = list ( filter ( |i | {  i . get ( "runtimeDependencySetType" , None /* Option */ ) != "framework" , e [ "installers" ] ) ) };
        return  expected;
        pub fn check_directories ( c , g , major , minor )  {
        check_list_match ( |a , e | {  matches ( a [ "source" ] , e [ "source" ] ) , c [ "directories" ] , gen_check_directories ( c , g ) , };
        check = check_directory ( c , major , minor ) ,;
        check_exception = |a , e | {  "Directory source: %s" % a [ "source" ] , };
        missing_exception = |e | {  "Directory source: %s" % e [ "source" ] , };
        extra_exception = |a | {  "Directory source: %s" % a [ "source" ] ) };
        pub fn gen_check_build_system_targets ( c , g , inSource )  {
        expected = [;
        ...
        } else if e [ "name" ] == "shared_framework" {
        ...
        if args . cxx_compiler_id in [ "Clang" , "AppleClang" , "LCC" , "GNU" , "Intel" , "IntelLLVM" , "MSVC" , "Embarcadero" , "CrayClang" , "IBMClang" ] && g [ "name" ] != "Xcode" {
        for e in expected .iter() {
        if e [ "name" ] == "cxx_exe" {
        ...
        if args . cxx_compiler_id != "MSVC" && args . cxx_simulate_id != "MSVC" {
        for e in expected .iter() {
        if !e [ "compileGroups" ] {
        continue;
        for group in e [ "compileGroups" ] .iter() {
        if !group [ "defines" ] {
        continue;
        group vec![ "defines" ] = vec![ d.iter().map(|d| group vec![ "defines" ] if d && d vec![ "define" ] != "_WINDLL" && d vec![ "define" ] != "_MBCS" ).collect();
        if len ( group [ "defines" ] ) == 0 {
        group [ "defines" ] = None /* Option */;
        ...
        if !os . path . exists ( os . path . join ( reply_dir , ".." , ".." , ".." , ".." , "ipo_enabled.txt" ) ) {
        for e in expected .iter() {
        // try {
        e [ "link" ] [ "lto" ] = None /* Option */;
        // } catch  TypeError  {
        // pass
        // try {
        e [ "archive" ] [ "lto" ] = None /* Option */;
        // } catch  TypeError  {
        // pass
        if inSource {
        for e in expected .iter() {
        if e [ "sources" ] is !None /* Option */ {
        for s in e [ "sources" ] .iter() {
        s [ "path" ] = s [ "path" ] . replace ( "^.*/Tests/RunCMake/FileAPI/" , "^" , 1 );
        if e [ "sourceGroups" ] is !None /* Option */ {
        for group in e [ "sourceGroups" ] .iter() {
        group vec![ "sourcePaths" ] = vec![ p . replace ( "^.*/Tests/RunCMake/FileAPI/" , "^" , 1 ).iter().map(|p| group vec![ "sourcePaths" ] ).collect();
        if e [ "compileGroups" ] is !None /* Option */ {
        for group in e [ "compileGroups" ] .iter() {
        group vec![ "sourcePaths" ] = vec![ p . replace ( "^.*/Tests/RunCMake/FileAPI/" , "^" , 1 ).iter().map(|p| group vec![ "sourcePaths" ] ).collect();
        if matches ( g [ "name" ] , "^Visual Studio " ) {
        expected = filter_list ( |e | {  e [ "name" ] !in ( "ZERO_CHECK" ) || e [ "id" ] == "^ZERO_CHECK::@6890427a1f51a3e7e1df$" , expected ) };
        for e in expected .iter() {
        if e [ "type" ] == "UTILITY" {
        ...
        "isGenerated" : true ,;
        "fileSetName" : None /* Option */ ,;
        "sourceGroupName" : "CMake Rules" ,;
        "compileGroupLanguage" : None /* Option */ ,;
        "backtrace" : [;
        {;
        "file" : "^CMakeLists\\.txt$" ,;
        "line" : None /* Option */ ,;
        ...
        } else if e [ "name" ] in ( "ALL_BUILD" ) {
        e [ "sources" ] = [ ];
        e [ "sourceGroups" ] = None /* Option */;
        if e [ "dependencies" ] is !None /* Option */ {
        ...
        if ";" in os . environ . get ( "CMAKE_OSX_ARCHITECTURES" , "" ) {
        expected = filter_list ( |e | {  e [ "name" ] !in ( "link_imported_object_exe" ) , expected ) };
        for e in expected .iter() {
        e [ "dependencies" ] = filter_list ( |d | {  !matches ( d [ "id" ] , "^\\^link_imported_object_exe::@" ) , e [ "dependencies" ] ) };
        e [ "orderDependencies" ] = filter_list ( |d | {  !matches ( d [ "id" ] , "^\\^link_imported_object_exe::@" ) , e [ "orderDependencies" ] ) };
        if e [ "name" ] in ( "c_object_lib" , "cxx_object_lib" , "inject_direct_lib_impl" ) {
        e [ "artifacts" ] = None /* Option */;
        } else {
        for e in expected .iter() {
        e [ "dependencies" ] = filter_list ( |d | {  !matches ( d [ "id" ] , "^\\^ZERO_CHECK::@" ) , e [ "dependencies" ] ) };
        expected = filter_list ( |t | {  t [ "name" ] !in ( "ALL_BUILD" , "ZERO_CHECK" ) , expected ) };
        if sys . platform !in ( "win32" , "cygwin" , "msys" ) {
        for e in expected .iter() {
        e [ "artifacts" ] = filter_list ( |a | {  !a [ "_dllExtra" ] , e [ "artifacts" ] ) };
        if e [ "install" ] is !None /* Option */ {
        e [ "install" ] [ "destinations" ] = filter_list ( |d | {  "_dllExtra" !in d || !d [ "_dllExtra" ] , e [ "install" ] [ "destinations" ] ) };
        } else {
        for e in expected .iter() {
        if e [ "install" ] is !None /* Option */ {
        e [ "install" ] [ "destinations" ] = filter_list ( |d | {  "_namelink" !in d || !d [ "_namelink" ] , e [ "install" ] [ "destinations" ] ) };
        if "aix" !in sys . platform {
        for e in expected .iter() {
        e [ "artifacts" ] = filter_list ( |a | {  !a . get ( "_aixExtra" , false ) , e [ "artifacts" ] ) };
        return  expected;
        pub fn gen_check_abstract_targets ( c , g , inSource )  {
        expected = [;
        ...
        if g [ "name" ] == "Xcode" {
        if ";" in os . environ . get ( "CMAKE_OSX_ARCHITECTURES" , "" ) {
        expected = filter_list ( |e | {  e [ "name" ] !in ( "imported_object_lib" ) , expected ) };
        if sys . platform !in ( "win32" , "cygwin" , "msys" ) {
        for e in expected .iter() {
        e [ "artifacts" ] = filter_list ( |a | {  !a [ "_dllExtra" ] , e [ "artifacts" ] ) };
        return  expected;
        pub fn check_build_system_targets ( c , g , major , minor , inSource )  {
        check_list_match ( |a , e | {  matches ( a [ "id" ] , e [ "id" ] ) , };
        c [ "targets" ] , gen_check_build_system_targets ( c , g , inSource ) ,;
        check = check_target ( c , major , minor ) ,;
        check_exception = |a , e | {  "Target ID: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Target ID: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Target ID: %s" % a [ "id" ] ) };
        pub fn check_abstract_targets ( c , g , major , minor , inSource )  {
        check_list_match ( |a , e | {  matches ( a [ "id" ] , e [ "id" ] ) , };
        c [ "abstractTargets" ] , gen_check_abstract_targets ( c , g , inSource ) ,;
        check = check_target ( c , major , minor ) ,;
        check_exception = |a , e | {  "Abstract target ID: %s" % a [ "id" ] , };
        missing_exception = |e | {  "Abstract target ID: %s" % e [ "id" ] , };
        extra_exception = |a | {  "Abstract target ID: %s" % a [ "id" ] ) };
        pub fn gen_check_projects ( c , g )  {
        expected = [;
        ...
        if matches ( g [ "name" ] , "^Visual Studio " ) {
        for e in expected .iter() {
        if e [ "parentName" ] is !None /* Option */ {
        e [ "targetIds" ] = filter_list ( |t | {  !matches ( t , "^\\^ZERO_CHECK" ) , e [ "targetIds" ] ) };
        } else if g [ "name" ] == "Xcode" {
        if ";" in os . environ . get ( "CMAKE_OSX_ARCHITECTURES" , "" ) {
        for e in expected .iter() {
        ...
        e [ "targetIds" ] = filter_list ( |t | {  !matches ( t , "^\\^(ALL_BUILD|ZERO_CHECK)" ) , e [ "targetIds" ] ) };
        return  expected;
        pub fn check_projects ( c , g )  {
        check_list_match ( |a , e | {  is_string ( a [ "name" ] , e [ "name" ] ) , c [ "projects" ] , gen_check_projects ( c , g ) , };
        check = check_project ( c ) ,;
        check_exception = |a , e | {  "Project name: %s" % a [ "name" ] , };
        missing_exception = |e | {  "Project name: %s" % e [ "name" ] , };
        extra_exception = |a | {  "Project name: %s" % a [ "name" ] ) };
        pub fn check_object_codemodel_configuration ( c , g , major , minor , inSource )  {
        ...
        check_projects ( c , g );
        pub fn check_object_codemodel ( g , major , minor )  {
        pub fn _check ( o )  {
        ...
        if g [ "multiConfig" ] {
        assert sorted ( vec![ c vec![ "name" ].iter().map(|c| o vec![ "configurations" ] ] ) == vec![ "Debug" , "MinSizeRel" , "RelWithDebInfo" , "Release" ).collect();
        } else {
        assert len ( o [ "configurations" ] ) == 1;
        assert o [ "configurations" ] [ 0 ] [ "name" ] in ( "" , "Debug" , "Release" , "RelWithDebInfo" , "MinSizeRel" );
        for c in o [ "configurations" ] .iter() {
