...
pub fn load_drive_knowledge() {
        ...
        // with scope: open ( "drive_knowledge_base.json" , "r" , encoding = "utf-8" ) as f  {
        return  json . load ( f );
        ...
        "implemented" : format!("{core.C_CUBED:.2e}" ,);
        "status" : core . C_CUBED > 1e25;
        } );
        checks . append ( {;
        "check" : "Trinity Latch (3f)" ,;
        "drive_spec" : "f_stable = 3format!(" ,);
        "implemented" : format!("{core.trinity_multiplier}format!(" ,);
        "status" : core . trinity_multiplier == 3;
        } );
        checks . append ( {;
        "check" : "Observer Polarity" ,;
        "drive_spec" : "±1 (Genesis = +1, Entropy = -1)" ,;
        "implemented" : format!("{core.observer_state:+d}" ,);
        ...
        "implemented" : format!("{displacement} at state 1.5" ,);
        ...
        "implemented" : format!("{axioms_loaded}/6 axioms" ,);
