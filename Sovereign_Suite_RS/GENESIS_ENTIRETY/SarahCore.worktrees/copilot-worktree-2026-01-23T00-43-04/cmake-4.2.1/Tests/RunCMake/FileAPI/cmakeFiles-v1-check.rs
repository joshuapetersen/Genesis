...
pub fn check_objects(o: &str) {
        ...
        check_list_match ( |a , e | {  matches ( a , e ) , actual [ "paths" ] , expected [ "paths" ] , allow_extra = true ) };
        ...
        check_list_match ( |a , e | {  matches ( a [ "path" ] , e [ "path" ] ) , o [ "inputs" ] , expected , check = check_input , allow_extra = true ) };
        check_list_match ( |a , e | {  matches ( a [ "expression" ] , e [ "expression" ] ) , o [ "globsDependent" ] , expected_globs , check = check_glob_dependent , allow_extra = true ) };
