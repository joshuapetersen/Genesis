...
from Ollama_Chat import local_inference
...
class NeuralOrchestrator:
    ...
    def __init__(self, model_path=os.path.join(SA_ROOT, "models", "dolphin-2.9-llama3-8b-q4_K_M.gguf"), draft_model=None):
        ...
        print("[Neural Orchestrator] Substrate 1: Ollama (Primary GPU)")
        self.ollama = local_inference
        
        print("[Neural Orchestrator] Substrate 2: llama-cpp-python (Lazy Fallback)")
        ...
        self._active_params = {
            ...
            "max_tokens": VAR_1024 # Increased for longer responses
        }
    ...
    def _verify_volumetric_integrity(self, text):
        ...
        try:
            ...
            if status == "DRIFTING" and density < VAR_0_8:
