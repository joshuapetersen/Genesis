...
import { LayoutDashboard, Zap, Mic2, Activity, Package, MessageCircle, Palette, BrainCircuit } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  const navItems = [
    ...
    { id: DashboardTab.STUDIO, icon: Palette, label: '07' },
    { id: DashboardTab.NEURAL_CHAT, icon: BrainCircuit, label: '08' },
  ];
