...
const App: React.FC = () => {
  ...
  const rootStyle = {
    ...
    '--aeris-red': uiSettings.secondaryColor,
        ...
        <div className="flex-1 flex items-center justify-center p-4 overflow-hidden relative">
          {activeFeature ? (
            ...
            <div className="flex flex-col items-center gap-16 animate-in fade-in duration-1000">
              ...
              <span className="mono text-[22px] text-white/20 uppercase tracking-[2.5em] font-black ml-[2.5em]">AERIS_CORE</span>
