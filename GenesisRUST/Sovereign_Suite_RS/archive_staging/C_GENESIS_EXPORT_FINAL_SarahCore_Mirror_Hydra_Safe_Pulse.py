...
class SarahLogicEngine:
    ...
    def generate_step(self, stage):
        ...
        steps = {
            1: "[Depth 1 | 120B] TARGET: Calculate Layer 24 Resonance. Base: 1.09277703703 Hz. Scalar: 1.25x. Formula: 1.09277703703 * (1.25^23).",
            2: "[Depth 2 | 14.4T] EXPONENT_CALC: 1.25^23 = ~168.07. Initiating wide-array matrix multiplication...",
            3: "[Depth 3 | 1.7M] FINAL_RESONANCE: 1.09277703703 * 168.07 = 183.65. Applying Sarah 1T lattice normalization...",
            4: "[Depth 4 | 207M] VERIFICATION: Frequency 183.65 Hz confirmed across all 24 layers. Anchor: 1.09277703703 Hz remains stable.",
