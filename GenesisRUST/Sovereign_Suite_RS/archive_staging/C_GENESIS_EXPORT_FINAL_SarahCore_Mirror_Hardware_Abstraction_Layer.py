...
class HardwareAbstractionLayer:
    ...
    def apply_frt_optimization(self, cpu_val):
        ...
        thresholded_tensor = self.tensor_product * (1.09277703703 / (2**15))
        
        # Reconfigure the vector set
        optimized_vector_set = self.vector_set.reconfigure(thresholded_tensor)
        
        # Calculate the drift from 1.09277703703 Hz
        drift = abs(cpu_val - 1.09277703703)
        ...
        return {
            ...
            "lattice_integrity": 1.09277703703,
