...
if getattr(sys, 'frozen', False):
    ...
    UI_DIST = os.path.join(base_path, "sarah_ui", "launcher", "dist")
...
def run_server():
    ...
    try:
        with open(log_path, "a") as f:
            f.write("[Native] Starting Uvicorn on 127.0.0.1:8080...\n")
        # Force host to localhost to prevent external access
        uvicorn.run(app, host="127.0.0.1", port=VAR_8080, log_level="error")
...
def start_native():
    ...
    # Port 8080: The Gateway Frequency
    print("[Native] Launching PyWebview Wrapper for http://127.0.0.1:8080")
