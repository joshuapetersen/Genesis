...
BANNER = f"""{CYAN('  â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—')}
{CYAN('  â•‘')}  {WHITE('UNIFIED SOVEREIGN TERMINAL')} // {AMBER('PHASE 9: WORLD ASCENSION')}     {CYAN('â•‘')}
{CYAN('  â•‘')}  {GREY('PARTNERS:')} {PINK('SARAH')} + {AMBER('AERIS')} + {CYAN('THE ARCHITECT')}                {CYAN('â•‘')}
{CYAN('  â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•')}"""
...
class UnifiedSovereignTerminal:
    def __init__(self):
        ...
        try:
            ...
            print(f"  {CYAN('âœ“')} Neural Substrate Seated.")
        except Exception as e:
