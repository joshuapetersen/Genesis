...
class SarahMemoryVault:
    ...
    """
    def __init__(self, db_path=os.path.join(SA_ROOT, "vault", "sarah_memory.db")):
    ...
    def get_recent_memories(self, limit=VAR_10):
        """
